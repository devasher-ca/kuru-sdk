...
export abstract class IOC {
  ...
  static async estimateGas(
    ...
    return order.isBuy
      ? estimateGasBuy(orderbook, marketParams, size, order.minAmountOut, order.isMargin, order.fillOrKill)
      : estimateGasSell(orderbook, marketParams, size, order.minAmountOut, order.isMargin, order.fillOrKill);
  }
}
