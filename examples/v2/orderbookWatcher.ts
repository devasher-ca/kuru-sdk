...
class OrderbookWatcher {
        ...
        try {
            ...
            if (currentBlock > this.lastProcessedBlock) {
                if (this.eventQueue.has(this.lastProcessedBlock)) {
                    ...
                    console.log(`Block ${this.lastProcessedBlock} - Orderbooks are ${areEqual ? 'equal' : 'not equal'}`);
    ...
    private areOrderbooksEqual(a: OrderBookData, b: OrderBookData): boolean {
        // Check asks
        const asksEqual = a.asks.length === b.asks.length &&
        ...
        // Check bids
        const bidsEqual = a.bids.length === b.bids.length &&
